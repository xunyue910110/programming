// ##########################################
// Source file : SendParameterFromFile.h
...
#ifndef SendParameterFROMFILE_H_INCLUDED_C4915E98
#define SendParameterFROMFILE_H_INCLUDED_C4915E98
...
//##Documentation
//## 从配置文件中获取参数
class SendParameterFromFile
{
  public:
	//##ModelId=3B7B9847037D
	SendParameterFromFile(string configFilePath, string configFileName, string theDataSource);

	//##ModelId=3BD42C9C0223
   SendParameterFromFile(string configFilePath, string configFileName, int theDataSource);

	//##ModelId=3B7B984801DA
	~SendParameterFromFile();
  ...
  private:
	...
	//##Documentation
	//## 用于读取数据源配置文件的全部内容，存到SendParameterString容器中。
  ...
  private:
	...
	vector<string> m_SendParameterString_;

};

#endif /* SendParameterFROMFILE_H_INCLUDED_C4915E98 */
