...
//add for GSMNRI calling_forward cdr
const int UCF_LEFT_FILL  = 3;
const int UCF_RIGHT_FILL = 4;
const int CF_LEFT_FILL  = 5;
const int CF_RIGHT_FILL = 6;
//add end
