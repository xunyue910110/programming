...
grant insert, update, delete on TP_INFOLOAD_USERSERVSTATE to UOP_ACT2;
---建立同义词
create or replace synonym  UOP_ACT2.TP_INFOLOAD_USERSERVSTATE for UCR_ACT2.TP_INFOLOAD_USERSERVSTATE;