...
grant insert, update, delete on TP_INFOLOAD_USERSERVSTATE to UOP_ACT3;
---建立同义词
create or replace synonym  UOP_ACT3.TP_INFOLOAD_USERSERVSTATE for UCR_ACT3.TP_INFOLOAD_USERSERVSTATE;