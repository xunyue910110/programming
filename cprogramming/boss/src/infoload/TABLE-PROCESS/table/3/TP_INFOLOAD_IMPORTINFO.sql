...
grant insert, update, delete on TP_INFOLOAD_IMPORTINFO to UOP_ACT3;
---建立同义词
create or replace synonym  UOP_ACT3.TP_INFOLOAD_IMPORTINFO for UCR_ACT3.TP_INFOLOAD_IMPORTINFO;