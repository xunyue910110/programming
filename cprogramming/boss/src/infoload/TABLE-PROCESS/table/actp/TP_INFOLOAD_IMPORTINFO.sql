...
grant insert, update, delete on TP_INFOLOAD_IMPORTINFO to UOP_ACTP;
---建立同义词
create or replace synonym  UOP_ACTP.TP_INFOLOAD_IMPORTINFO for UCR_ACTP.TP_INFOLOAD_IMPORTINFO;