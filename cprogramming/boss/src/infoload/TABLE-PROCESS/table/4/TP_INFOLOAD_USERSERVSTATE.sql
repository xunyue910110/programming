...
grant insert, update, delete on TP_INFOLOAD_USERSERVSTATE to UOP_ACT4;
---建立同义词
create or replace synonym  UOP_ACT4.TP_INFOLOAD_USERSERVSTATE for UCR_ACT4.TP_INFOLOAD_USERSERVSTATE;