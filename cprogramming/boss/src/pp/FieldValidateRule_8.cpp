...
bool FieldValidateRule_8::initialize(string ruleText)
{
	...
	// example:	rule_8:VALID_TYPE=fields;CALL_TYPE=ALL;other_party   
...
int FieldValidateRule_8::validField()
{
    int len;
    char tmp[80];
    ...
    //tmpFieldInfo=m_pFieldInfos->getFieldInfoByName(callType.c_str());
    // 条件：通话类型
