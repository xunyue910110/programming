...
#ifndef CDRERRORCODE_H_HEADER_INCLUDED_B7A658E1
#define CDRERRORCODE_H_HEADER_INCLUDED_B7A658E1
...
const int ERROR_TOTAL_CDRS            =  103; // 总话单数错误 add by lizhao 2008-11-03
const int ERROR_TOTAL_FEE             =  104; // 总记录数错误 add by lizhao 2008-11-03
...
const int ERROR_COMMON_CDR         =  204; // 一般纪录级错误 add by lizhao 2008-11-03
...
const int FREE_FLAG_CDR_GSMN              =  OTHER_ERROR_BASE +  5; //联通G网北电交换机话单中免费标志

#endif /* CDRERRORCODE_H_HEADER_INCLUDED_B7A658E1 */
