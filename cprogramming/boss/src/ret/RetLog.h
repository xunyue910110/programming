...
#ifndef PPLOG_H_INCLUDED_C484A413
#define PPLOG_H_INCLUDED_C484A413
...
class RetLog
{
  public:
	...
	inline static RetLog *getInstance();
...
//##ModelId=3B6EA0580207
RetLog *RetLog::getInstance()
{
	if ( m_theRetLog == 0 )
		m_theRetLog= new RetLog;

	return m_theRetLog;
}

//##ModelId=3B57CCF203E4
void RetLog::setShowFlag(bool aShowFlag)
{
	m_isShow=aShowFlag;
}

//##ModelId=3B6955FE0159
string RetLog::getEndTime() const
{
    return m_EndDateTime;
}

//##ModelId=3B936D8B02F4
bool RetLog::isShowFlag()
{
	return m_isShow;
}

//##ModelId=3B6E542900F6
string RetLog::getStartTime() const
{
    return m_StartDateTime;
}

#endif /* PPLOG_H_INCLUDED_C484A413 */
