#ifndef Mdb_VpnInfo_UserId_H_HEADER_INCLUDED_20080901
#define Mdb_VpnInfo_UserId_H_HEADER_INCLUDED_20080901

#include "Mdb_Common.h"
#include "Mdb_VpnInfo_Number.h"
#include "FieldsXX.h"

class Mdb_VpnInfo_UserId
{
  public:
    ...
    Mdb_VpnInfo_UserId(const Mdb_VpnInfo_UserId& right);

    void operator=(const Mdb_VpnInfo_UserId& right);
    
    friend ostream& operator<<(ostream& os,const Mdb_VpnInfo_UserId& po);
    Mdb_VpnInfo_UserId& operator=(const Mdb_VpnInfo_Number& r_right);
    struct
    {
...
#endif //Mdb_VpnInfo_UserId_H_HEADER_INCLUDED_20080901
