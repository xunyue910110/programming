...
#include "PMHelper.h"
    ...
    int PMHelper::m_indicator = 0;
    
    map<string,ParamContainerBase*> * PMHelper::GetParamContainers() {
    ...
    ParamContainerBase * PMHelper::GetParamContainer(const string & name) {
    ...
    int PMHelper::SetParamContainer(const string &name,ParamContainerBase * container) 
        {
    ...
    //added by zhanglong 2006-7-19 16:54
    int PMHelper::SetParamContainer2(const string &name,ParamContainerBase * container) 
        {
            m_indicator = 1;
        map<string,ParamContainerBase*> &conts = *(GetParamContainers());
