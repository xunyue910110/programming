...
* 完成日期：
*/
#ifndef AcctBillFacApp_H
#define AcctBillFacApp_H
 ...
 */
class AcctBillFacApp : public Application
{
	public:
    ...
    private:
	    ...
	    ACCTBILLMAP                                    m_acctBillMap;
	    AcctBillFacInputFile                           m_acctBillFacInputFile;
      AcctBillFacOutputFile                          m_acctBillFacOutputFile;
