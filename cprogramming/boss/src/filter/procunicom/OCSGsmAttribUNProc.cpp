#include "OCSGsmAttribUNProc.h"

#include "FilterError.h"

INSTALL_PROCESSBASE_INSTANCE(OCSGsmAttribUNProc);

void OCSGsmAttribUNProc::initialattr()
{
  //如有原先规整的B号码，以规整为准
  ...
  //初始化计费号码的相关属性
  m_pcdr[ATTRI_USER_ASP_A] = "2" ;
  m_pcdr[ATTRI_USER_SERVICE_TYPE_A] = "01" ;
}


int OCSGsmAttribUNProc::execute()
{
 #ifdef FP_DEBUG
   FP_BEGIN(OCSGsmAttribUNProc)
 #endif
