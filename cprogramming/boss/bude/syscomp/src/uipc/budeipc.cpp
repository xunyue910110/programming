...
void budeipc::DDEBUG_CONSOLE(IPC_DLEV level, const char* file, int line, const char* msg, ...) {
...
void budeipc::DDEBUG_FILE(IPC_DLEV level,const char* file, int line, const char* fmt, ...) {
	if (level<=IPC_DEBUG_LEVEL) {
		FILE* fp;
		va_list ap;
		char sMsg[2048]="";
