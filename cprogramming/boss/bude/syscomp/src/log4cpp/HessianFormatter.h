#ifndef _HESSIANFORMATTER_H_
#define _HESSIANFORMATTER_H_
#include "log4cpp/Formatter.h"

USING_NAMESPACE(std);

namespace log4cpp{
	class HessianFormatter : public Formatter{
		public:
        /**
         * 初始化
		...
		HessianFormatter();
		~HessianFormatter() throw();
		private:
			string m_localaddr;
            string m_localCode;
			void parse(const char* fullname,string& output);
	};
};

#endif //_HESSIANFORMATTER_H_
