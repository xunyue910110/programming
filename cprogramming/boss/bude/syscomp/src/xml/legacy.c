 ...
 *
 * parse an XML namespace1 name.
 *
 * TODO: this seems not in use anymore, the namespace1 handling is done on
 ...
 *
 * Returns the namespace1 name or NULL
 */
 ...
 * @ctxt:  an XML parser context
 *
 * parse a namespace1 prefix declaration
 *
 * TODO: this seems not in use anymore, the namespace1 handling is done on
 *       top of the SAX interfaces, i.e. not on raw input.
 *
 ...
 * @ctxt:  an XML parser context
 *
 * xmlParseNamespace: parse specific PI '<?namespace1 ...' constructs.
 *
...
/**
 * xmlNewGlobalNs:
 * @doc:  the document carrying the namespace1
 * @href:  the URI associated
 * @prefix:  the prefix for the namespace1
 *
 * Creation of a Namespace, the old way using PI and without scoping
 *   DEPRECATED !!!
 * It now create a namespace1 on the root element of the document if found.
